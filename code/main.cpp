...
int main(int argc, char* argv[]){
	...
	for(int i = 1; i<N+1; i++){
		...
		outfile << "Time specalized algorithm:     " << setprecision(15) << Ferrari(g,n) << endl;
		outfile << "Time for the Thomas algorithm: " << setprecision(15) << Thomas_algorithm(g,dfdx,n) << endl;	
		//outfile << "Time for LU decomposition:     " << setprecision(15) << LU_solver(g,n) << endl;	
	}	
	outfile.close();
